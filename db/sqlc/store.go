...
type Store struct {
	*Queries
	db *sql.DB
	// require to create new db transactions
}
...
// add function to the store to execute db transaction
...
// It creates a transfer record, add account entries, and update accounts balance with a singe database transaction
